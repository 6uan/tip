...
# Understand: we want to check starting villagers neighbor and check that villagers neighbor until we teach target villager
...
def message_received(start_villager, target_villager):
    # starting_villager: isabelle -> isabelle.neighbor = tom_nook -> tom_nook.neighbor = kk_slider
    # target_villager: kk_slider
    current_villager = start_villager

    while current_villager.neighbor != None:
        if current_villager.neighbor == target_villager:
            return True
